...
public class metal_maps extends FragmentActivity implements GoogleMap.OnMarkerDragListener {

    public static double latitude = 0.0;
    public static double longitude = 0.0;

    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference ref = database.getReference("Metal");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Query queryRef = ref.orderByChild("metal");
                ...
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        if (locationProviders == null || locationProviders.equals("")) {
                            ...
                            if (metalMarker.getText().toString().equals("Add a Marker")) {
                                // Setting location for future use

                                metalMarker.setText("Save");
