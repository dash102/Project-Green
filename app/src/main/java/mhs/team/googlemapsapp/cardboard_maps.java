...
public class cardboard_maps extends FragmentActivity implements GoogleMap.OnMarkerDragListener {

    public static double latitude = 0.0;
    public static double longitude = 0.0;

    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference ref = database.getReference("Cardboard");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Query queryRef = ref.orderByChild("cardboard");
                ...
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        if (locationProviders == null || locationProviders.equals("")) {
                            ...
                            if (cardboardMarker.getText().toString().equals("Add a Marker")) {
                                // Setting location for future use

                                cardboardMarker.setText("Save");
